...
<body>
    ...
    <div id="main-div">
        ...
        <div class="container py-5">
            ...
            <h3 class="heading-text text-medium mb-5">Archived Materials</h3>

            
            <div class="table-div shadow">
                <table class="table table-border" id="materials-table">
                    <thead>
                        <tr>
                            <th></th>
                            <th>MATERIAL</th>
    ...
    <form class="modal-form" method="post" action="actions/materialActions.php">
        <div class="modal fade ressetable-modal" id="restoreMaterialModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-medium" id="exampleModalLongTitle">Restore Material</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <input type="hidden" name="materialId" id="restoreMaterial-materialId">
                    
                    <p class="text-center">
                        Are you sure you want to restore the selected material?<br>
                        <b id="restoreMaterial-materialNameText"></b>
                    </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary" name="action" value="restore_material">Restore</button>
                </div>
                </div>
            </div>
        </div>
    ...
    <script src="./js/adm/adm-archivedMaterials.js?t=<?=time()?>"></script>
